...
export class FighterEnemy extends Phaser.GameObjects.Container {
  ...
  constructor(scene, x, y) {
    ...
    this.#shipSprite = scene.add.sprite(0, 0, 'fighter', 0).setRotation(1.57).setScale(2);
    this.#shipEngineSprite = scene.add.sprite(0, 0, 'fighter_engine').setFlipY(true).setRotation(1.57).setScale(2);
    this.#shipEngineSprite.play('fighter_engine').setRotation(1.57).setScale(2);
